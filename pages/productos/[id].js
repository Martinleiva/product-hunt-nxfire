...
const Producto = () => {
    ...
    const { comentarios, creado, descripcion, empresa, nombre, url, urlimagen, votos, creador
    , haVotado } = producto;
    ...
    const votarProducto = () => {
        ...
        //Hay un voto, entonces consultar a la base de datos
    ...
    const agregarComentario = (e) => {
        ...
        ///Hay un comentario, entonces consultar a la base de datos
        guardarConsultarDB(true);
    }
